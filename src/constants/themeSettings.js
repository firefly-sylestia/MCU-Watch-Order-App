...
export const THEME_PALETTES = {
  ...
  daredevil: { accent: '#BF0615', accentAlt: '#A61731', darkSurface: 'rgba(68,34,38,0.92)', lightSurface: 'rgba(255,242,243,0.96)', darkSurfaceHover: 'rgba(88,44,49,0.94)', lightSurfaceHover: 'rgba(255,228,230,0.98)', darkCompCard: 'rgba(58,30,34,0.88)', lightCompCard: 'rgba(255,246,247,0.95)' },
  ...
  'marvel-red': { accent: '#e23636', accentAlt: '#f78f3f', darkSurface: 'rgba(47,39,41,0.92)', lightSurface: 'rgba(255,245,245,0.96)', darkSurfaceHover: 'rgba(64,53,56,0.94)', lightSurfaceHover: 'rgba(255,233,233,0.97)', darkCompCard: 'rgba(56,46,49,0.88)', lightCompCard: 'rgba(255,248,248,0.95)' },
