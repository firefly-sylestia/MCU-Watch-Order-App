...
export default function MCUViewer() {
  ...
  const renderPhaseSelector = () => (
    ...
    <div ref={phaseRef} className="phase-selector-rail">
      <button className="fpill phase-chip marvel-phase-btn" data-active={activePhase === 0} onClick={() => { setBrowseMode('phase'); setActivePhase(0); }}>
  ...
  <div className="settings-redesign">
    ...
    <section className="settings-card settings-drive-guide-card">
      ...
      <ol className="settings-guide-list">
        ...
        <li>Use the quick upload link below to open your Google Drive instantly.</li>
        <li>Upload the JSON backup file to Drive.</li>
        <li>On a new device, download the same JSON from Drive.</li>
        <li>Tap <b>Import Backup JSON</b> in this app and select that file.</li>
      </ol>
      <a className="fpill settings-drive-link" href="https://drive.google.com/drive/u/0/my-drive" target="_blank" rel="noreferrer" style={{ justifyContent: 'center' }}>
        <Upload size={14} /> Open Google Drive Upload Page
      </a>
    </section>
  </div>
</SettingsMenu>
