...
const SORT_LABELS = { order: 'Chronology', year: 'Year', title: 'A–Z', runtime: 'Runtime', watched: 'Recent', status: 'Status' };
        ...
        <div style={{ maxWidth: 1480, margin: '0 auto', padding: '0 16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', flexWrap: 'wrap' }}>
            ...
            <div ref={sortMenuRef} style={{ position: 'relative' }}>
              ...
              {sortMenuOpen && <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet" style={{ position: 'absolute', top: 'calc(100% + 8px)', left: 0, zIndex: 1450, width: 'min(210px, calc(100vw - 24px))', maxHeight: 'min(42vh, 240px)', overflowY: 'auto' }}>
                {Object.entries(SORT_LABELS).map(([key, label]) => (
                  <button key={key} className={`sopt ${sortBy === key ? 'picked' : ''}`} onClick={() => { setSortBy(key); setSortMenuOpen(false); }} style={{ width: '100%', textAlign: 'left' }}>{label}</button>
                ))}
              </div>}
            </div>
            <div ref={timelineRef} style={{ position: 'relative' }}>
              ...
              {timelineOpen && (
                <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet" style={{ position: 'absolute', top: 'calc(100% + 8px)', left: 0, zIndex: 1450, width: 'min(230px, calc(100vw - 24px))', maxHeight: 'min(46vh, 280px)', overflowY: 'auto' }}>
