...
export default function MCUViewer() {
  ...
  const cssThemeVars = {
    ...
    '--theme-text-muted': darkMode ? '#9fb1cb' : '#5b6678',
    '--theme-button-bg': darkMode ? 'color-mix(in srgb, var(--theme-surface) 82%, rgba(255,255,255,0.04))' : 'color-mix(in srgb, var(--theme-surface) 92%, #ffffff)',
    '--theme-button-bg-hover': darkMode ? 'color-mix(in srgb, var(--theme-accent) 18%, var(--theme-surface-hover))' : 'color-mix(in srgb, var(--theme-accent) 10%, #ffffff)',
    '--theme-button-border': darkMode ? 'color-mix(in srgb, var(--theme-accent) 34%, var(--theme-border))' : 'color-mix(in srgb, var(--theme-border) 94%, #9ca3af)',
    '--theme-button-text': darkMode ? '#e6edf8' : '#182031',
    '--theme-detail-surface': darkMode ? 'linear-gradient(150deg, color-mix(in srgb,var(--theme-surface) 92%, #000), color-mix(in srgb,var(--theme-bg) 84%, #000))' : 'linear-gradient(150deg, color-mix(in srgb, var(--theme-surface) 96%, #ffffff), color-mix(in srgb, var(--theme-bg) 82%, #f3f6fb))',
