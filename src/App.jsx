        ...
        <div style={{ maxWidth: 1480, margin: '0 auto', padding: '0 16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', flexWrap: 'wrap' }}>
            ...
            <div ref={sortMenuRef} style={{ position: 'relative' }}>
              ...
              {sortMenuOpen && <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet" style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, zIndex: 1450, width: 'min(240px, calc(100vw - 28px))', maxHeight: 'min(46vh, 280px)', overflowY: 'auto' }}>
            ...
            <div ref={timelineRef} style={{ position: 'relative' }}>
              ...
              {timelineOpen && (
                <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet" style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, zIndex: 1450, width: 'min(260px, calc(100vw - 28px))', maxHeight: 'min(52vh, 320px)', overflowY: 'auto' }}>
