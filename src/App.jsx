        ...
        <div style={{ maxWidth: 1480, margin: '0 auto', padding: '0 16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', flexWrap: 'wrap' }}>
            ...
            <div ref={sortMenuRef} style={{ position: 'relative' }}>
              ...
              {sortMenuOpen && <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet centered-open-dropdown mobile-safe-dropdown" style={{ position: 'absolute', top: 'calc(100% + 8px)', left: '50%', transform: 'translateX(-50%)', zIndex: 1450, width: 'min(220px, calc(100vw - 28px))', maxHeight: 'min(42vh, 260px)', overflowY: 'auto' }}>
            ...
            <div ref={timelineRef} style={{ position: 'relative' }}>
              ...
              {timelineOpen && (
                <div className="dropdown-pop filter-dropdown redesigned-sort-menu modern-control-sheet compact-dropdown-sheet centered-open-dropdown mobile-safe-dropdown" style={{ position: 'absolute', top: 'calc(100% + 8px)', left: '50%', transform: 'translateX(-50%)', zIndex: 1450, width: 'min(240px, calc(100vw - 28px))', maxHeight: 'min(48vh, 300px)', overflowY: 'auto' }}>
