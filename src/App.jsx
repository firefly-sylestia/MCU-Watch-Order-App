            ...
            {!trailerExpanded && <div className="trailer-head">
              <div>
                ...
                {trailerOptions.length > 1 && (
                  <label className="trailer-variant-label">
                    ...
                    <select className="trailer-variant-select" value={trailerVariantIndex} onChange={(e) => setTrailerVariantIndex(Number(e.target.value))}>
                      {trailerOptions.map((option, index) => (
                        <option key={`${option.youtubeId}-${index}`} value={index}>
                          {`${option.type === 'teaser' ? 'Teaser' : 'Trailer'} · ${option.label}`}
                        </option>
                      ))}
                    </select>
                  </label>
              ...
              <div className="trailer-actions">
                <button className="fpill trailer-close" onClick={handleTrailerLandscapeToggle} aria-label={trailerLandscape ? 'Switch to portrait mode' : 'Switch to landscape mode'} title={trailerLandscape ? 'Switch to portrait mode' : 'Switch to landscape mode'}><SwitchIcon size={12}/>View</button>
