      ...
      {wardrobeOpen && (
        <div className="wardrobe-modal-backdrop" role="dialog" aria-modal="true">
          <div className="wardrobe-modal-shell motion-fade-up">
            ...
            <div className="wardrobe-ring-wrap" onWheel={(e) => { e.preventDefault(); setWardrobeAngle(a => a + (e.deltaY > 0 ? 16 : -16)); }}>
              <div className="wardrobe-ring-stage">
                <div className="wardrobe-ring" style={{ transform: `translateZ(-280px) rotateY(${wardrobeAngle}deg)` }}>
